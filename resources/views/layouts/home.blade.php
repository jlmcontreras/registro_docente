                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">Cargos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{route('docente.index')}}">Docentes</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div>
                            @if (Route::has('login'))
                                <div class="text-end sm:block ">
                                    @auth
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{ url('/layouts/home') }}">Home</a>
                                                </li>
                                    ...
                                    @else
                                        <a href="{{ route('login') }}"
                                           class="text-sm text-gray-700 dark:text-white underline">Log in</a>
